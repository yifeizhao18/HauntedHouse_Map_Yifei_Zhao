...
possibleResults = {
  "result1" : "ghost1 appeared behind the curtain. You need to use bandages to heal if you have them or LEAVE immediately and find bandages. ",
  "result2" : "ghost2 appeared. You need to use pills to heal yourself. ",
  "result3" : "You found a treasure chest with bandages and pills. ",
  "result4" : "THE ghost appeared. You need to use pills and bandages to heal yourself. ",
